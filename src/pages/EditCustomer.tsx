        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <div>
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                disabled={saving}
                className="p-2 border border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors disabled:opacity-50"
          ...
          <div className="flex items-center gap-3">
            <button 
              onClick={() => navigate('/customers')}
              disabled={saving}
              className="px-6 py-3 border border-[#edeeef] text-[#162839] text-[14px] font-bold rounded-xl hover:bg-neutral-50 transition-colors flex items-center gap-2 disabled:opacity-50"
            >
              Cancel
            </button>
            <button 
