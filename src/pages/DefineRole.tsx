...
export default function DefineRole() {
  ...
  const modules = [
    ...
    { name: 'Labour', icon: Package, view: true, edit: true, delete: false, export: false },
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-4">
          ...
          <button 
            ...
            disabled={saving}
            className="bg-[#006397] text-white px-10 py-3 rounded-xl font-bold hover:opacity-90 transition-all shadow-lg uppercase tracking-widest text-[13px] flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving && (
               <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
            )}
            {saving ? 'Saving...' : 'Save Role Class'}
          </button>
        </div>
      </div>
