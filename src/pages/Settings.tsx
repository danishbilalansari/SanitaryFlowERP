          ...
          <div className="grid grid-cols-12 gap-8">
            <section className="col-span-12 lg:col-span-7 bg-white p-8 rounded-xl border border-[#edeeef] shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 space-y-2">
                  <label className="text-[13px] font-bold text-[#162839] block">Company Address</label>
                  <textarea
                    value={companyAddress}
                    onChange={(e) => setCompanyAddress(e.target.value)}
                    className="w-full bg-[#f8f9fa] border border-[#c4c6cd] rounded px-4 py-2.5 text-[14px] font-medium focus:ring-2 focus:ring-[#5cb8fd] outline-none transition-all min-h-[90px]"
