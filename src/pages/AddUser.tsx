      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex gap-4">
          <button 
            ...
            disabled={saving}
            className="px-8 py-3 bg-white border border-[#c4c6cd] text-[#162839] font-bold rounded-xl hover:bg-neutral-50 transition-all text-[13px] uppercase tracking-widest shadow-sm disabled:opacity-50"
          >
            Cancel
          </button>
          <button 
            ...
            disabled={saving}
            className="bg-[#006397] text-white px-8 py-3 rounded-xl font-bold flex items-center gap-2 hover:opacity-90 transition-all shadow-lg uppercase tracking-widest text-[13px] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving && (
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-[#edeeef]">
        ...
        <div className="flex gap-4 w-full md:w-auto">
          <button 
            onClick={() => navigate('/settings')}
            disabled={saving}
            className="flex-1 md:flex-none px-8 py-4 bg-white border border-[#edeeef] text-neutral-500 font-black text-[14px] rounded-2xl hover:bg-neutral-50 transition-all uppercase tracking-widest disabled:opacity-50"
          >
            Discard Draft
          </button>
          <button 
            onClick={handleCreateUser}
            disabled={saving}
            className="flex-1 md:flex-none px-12 py-4 bg-[#006397] text-white font-black text-[14px] rounded-2xl hover:opacity-90 transition-all shadow-xl flex items-center justify-center gap-3 uppercase tracking-widest disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving && (
               <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
            )}
            {saving ? 'Finalizing...' : 'Finalize & Create User'}
          </button>
        </div>
      </div>
    </div>
