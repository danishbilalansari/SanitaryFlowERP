      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <section className="lg:col-span-2 bg-white rounded-2xl border border-[#edeeef] p-8 shadow-sm flex flex-col md:flex-row gap-8 items-start">
          <div className="w-48 h-48 bg-[#f8f9fa] rounded-2xl flex items-center justify-center border border-[#edeeef] shrink-0 overflow-hidden">
            <ItemImage src={item.image} name={item.name} className="w-full h-full object-cover text-3xl" />
          </div>
          <div className="flex-1 w-full">
            <div className="flex flex-col xl:flex-row justify-between items-start gap-6">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[14px] text-neutral-500 font-medium mt-3 leading-relaxed">
            ...
            {showAdjust && (
              <div className="mt-6 p-6 bg-neutral-50 rounded-xl border-2 border-dashed border-[#5cb8fd] space-y-4 animate-in slide-in-from-top-2 duration-300">
                ...
                <button 
                  ...
                  className="w-full bg-[#162839] text-white font-bold py-3 rounded-lg hover:opacity-90 transition-all text-[12px] uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isAdjusting && (
        ...
        <section className="bg-white rounded-2xl border border-[#edeeef] p-8 shadow-sm">
          ...
          <div className="space-y-4">
            {[
              ...
              { label: 'Product Line', value: item.product_line || '-' },
              { label: 'Size', value: item.size || '-' },
              { label: 'Packing', value: item.packing || '-' },
