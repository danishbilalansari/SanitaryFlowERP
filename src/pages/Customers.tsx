          ...
          {totalPages > 1 && (
            <div className="px-8 py-4 bg-[#f8f9fa] border-t border-[#edeeef] flex justify-between items-center">
              <span className="text-[13px] font-bold text-neutral-400">
                Showing <span className="text-[#162839]">{(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredCustomers.length)}</span> of <span className="text-[#162839]">{filteredCustomers.length}</span> customers
              </span>
