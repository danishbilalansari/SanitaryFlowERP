...
export default function Dashboard() {
  ...
  const kpis = [
    { label: 'Inventory Value', value: `${formatCurrency((stats?.stockValue || 0), currency)}`, trend: null, sub: 'Total Asset Value', icon: Package, color: 'text-orange-500', bg: 'bg-orange-50' },
    ...
    { label: 'Weekly Efficiency', value: `${stats?.productionEfficiency || 0}%`, trend: null, sub: 'Target vs Actual', icon: TrendingUp, color: 'text-emerald-500', bg: 'bg-emerald-50' },
    { label: 'Production Batches', value: stats?.productionStats?.reduce((acc: number, s: any) => acc + Number(s.count), 0) || 0, trend: null, sub: 'Total Batches', icon: Factory, color: 'text-blue-500', bg: 'bg-blue-50' },
  ];
